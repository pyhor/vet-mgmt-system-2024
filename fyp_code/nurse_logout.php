...
<body>
  <article>
    <?php
      ...
      $nursesOnline = array_filter($nursesOnline, function($entry) {
        return $entry->id != $_SESSION["nurseid"];
      });

      file_put_contents("livechat_nursesOnline.json", json_encode(array_values($nursesOnline)));
      
      // Unset specific session variables
      unset($_SESSION["nurseid"]);
      unset($_SESSION["nurseusername"]);
