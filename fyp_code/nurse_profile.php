...
<head>
    ...
    <title>Nurse Profile | VCMS </title>
</head>
<body>
    <nav>
...
<div class="container">
    <div class="profile-section">
        ...
        <div style="text-align: center; margin-top: 20px;">
            <a href="nurse_edit_profile.php?nurseid=<?php echo $nurseid; ?>" class="button">Edit Profile</a>
        </div>
    </div>
</div>
